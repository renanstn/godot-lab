...
- This example implements a 3D arcade race car mechanic. This technic uses a sphere to run all the physics, and visually replace the sphere for the car 3D model
